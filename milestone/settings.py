...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mileapp.context_processors.CartCount',
                'mileapp.context_processors.WishCount',
...
#there is a block of code that we want to be adding for the email snding #

EMAIL_BACKEND='django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST='smtp.gmail.com'
EMAIL_PORT='587'
EMAIL_HOST_USER='shraavana09@gmail.com'
EMAIL_HOST_PASSWORD='ithfxzzigrgcwoct'
EMAIL_USE_TLS=True
