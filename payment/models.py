...
from mileapp.models import User,Product,ProductAttribute
...
class Transaction(models.Model):
     user=models.ForeignKey(User,on_delete=models.CASCADE)
     amount_paid=models.ForeignKey(Payments,on_delete=models.CASCADE,blank=True,null=True)
     order_number = models.CharField(max_length=20,default=None)
     razorpay_paymnet_id=models.CharField(max_length=100,blank=True)
